...
<html>
  ...
  <body>
    ...
    <div class="row">
      <div class="col-md-auto" id="dashboard">
        ...
        <a href="query3.php"><button class="custom-button"><h4>Get Driver Information</h4></button></a></br>
        <a href="query4.php"><button class="custom-button"><h4>Get Donor Information</h4></button></a></br>
        <a href="query5.php"><button class="custom-button"><h4>Get Donation Amount</h4></button></a></br>
        <a href="query6.php"><button class="custom-button"><h4>Adopt a Pet</h4></button></a></br>
